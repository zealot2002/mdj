...
public class TimePickerPopupWindow extends PopupWindow {
	...
	public TimePickerPopupWindow(Context context, final onTimeSelectListener listener, String[] timeDate) {
		super(context);
		...
		wheelView = (WheelView) mMenuView.findViewById(R.id.cityWheel);
		initWheelView();
