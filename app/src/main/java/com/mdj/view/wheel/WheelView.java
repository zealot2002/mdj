...
import com.mdj.R;
import com.mdj.view.wheel.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	//*/
	private int[] SHADOWS_COLORS = new int[] {Color.TRANSPARENT,
...
//	private int wheelBackground = R.drawable.wheel_bg;
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(Color.rgb(254, 103, 113));
//		paint.setColor(getResources().getColor(Color.rgb(254, 103, 113)));
