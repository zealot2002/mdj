...
/**
* @Title: ChineseTextView.java 
* @Package com.mdj.view.textView 
* @Description: 更改字体的文本
* @author Jalen  c9n9m@163.com  
* @date 2015年3月28日 下午1:39:51 
* @version V1.0
 */
public class ChineseCheckBox extends CheckBox {

	public ChineseCheckBox(Context context, AttributeSet attrs) {
		super(context, attrs);
		/*
