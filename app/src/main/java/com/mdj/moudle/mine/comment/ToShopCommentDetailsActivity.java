 ...
 * @Description: 到店评价详情
 */
public class ToShopCommentDetailsActivity extends BaseActivity implements View.OnClickListener, CommentContract.View {
    ...
    public void findViews() {
        setContentView(R.layout.toshop_commentdetails_activity);
        mContext = this;
