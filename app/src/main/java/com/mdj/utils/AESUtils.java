...
/**
 * @Title: AesEncryptionUtil.java
 * @Package com.example.aes
 * @Description: AES加密解密算法
 * 
 *               编码方式有两种，一种是base64，一种是十六进制
 * 
 *               目前项目中用的是base64转码解码
 * @author hwk
 * @date 2015-9-10 下午3:19:59
 */
public class AESUtils {
	...
	public static String encrypt(String content, String password, String iv) {
		...
		String result = Base64.encodeToString(data, Base64.DEFAULT);// base64转码
	...
	public static String decrypt(String content, String password, String iv) {
		...
		try {
			...
			data = Base64.decode(content, Base64.DEFAULT);// base64解码
		} catch (Exception e) {
			e.printStackTrace();
		}
