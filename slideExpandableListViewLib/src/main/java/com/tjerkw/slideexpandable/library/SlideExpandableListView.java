...
class SlideExpandableListView extends ListView {
    ...
    public void setAdapter(ListAdapter adapter, int toggle_button_id, int expandable_view_id,OnItemExpandCollapseListener listener) {
        this.adapter = new SlideExpandableListAdapter(adapter, toggle_button_id, expandable_view_id,listener);
        super.setAdapter(this.adapter);
    }
