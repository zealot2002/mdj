...
import com.example.slideexpandablelistviewlib.R;
...
public class SlideExpandableListAdapter extends AbstractSlideExpandableListAdapter {
	...
	public SlideExpandableListAdapter(ListAdapter wrapped, int toggle_button_id, 
			int expandable_view_id,OnItemExpandCollapseListener listener) {
		super(wrapped);
		this.toggle_button_id = toggle_button_id;
		this.expandable_view_id = expandable_view_id;
		setItemExpandCollapseListener(listener);
	}

	public SlideExpandableListAdapter(ListAdapter wrapped) {
		this(wrapped, R.id.expandable_toggle_button, R.id.expandable,null);
	}
